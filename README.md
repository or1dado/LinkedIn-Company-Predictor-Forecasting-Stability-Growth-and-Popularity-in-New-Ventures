...
<ol>
  ...
  <li>
    <p>Utilize the "scrape code" to initiate the scraping process from the URLs extracted in the preceding phase. This step remains optional and is solely necessary if you opt to conduct the scraping process autonomously. It's worth noting that the data is already accessible in the data file.</p>
  </li>
  <li>
